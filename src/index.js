...
const getListStyle = (isDraggingOver) => ({
  backgroundColor: isDraggingOver ? '#3d3d3d' : 'lightgrey',
  padding: GRID,
  width: 250,
});
...
const App = () => {
  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col ml-7 mr-7 w-full border-2 border-gray-300 bg-[#3d3d3d] p-4 text-white">
        ...
        <div className="mt-4 font-semibold">제약 조건</div>
        <span>1. 1번째 컬럼에서 3번째 컬럼으로는 이동이 불가능합니다.</span>
        <span>2. 짝수 아이템의 위로 짝수 아이템을 놓을 수 없습니다.</span>
